...
| Scenario | 1. Customer logs in. <br> 2. System provides the main view which contains "View booking request" button which contains all booking requests(pending, rejected, accepted) in a view  |
